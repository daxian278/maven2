                                ...
                                .addGroup(layout.createParallelGroup(Alignment.LEADING, false)
                                        .addGroup(layout.createSequentialGroup()
                                                ...
                                                .addGroup(layout.createParallelGroup(Alignment.TRAILING, false)
                                                        .addComponent(newPasswordConfirmTxt, Alignment.LEADING)
                                                        .addComponent(newPasswordTxt, Alignment.LEADING)
                                                        .addComponent(oldPasswordTxt, Alignment.LEADING)
                                                        .addComponent(userNameTxt, Alignment.LEADING, GroupLayout.DEFAULT_SIZE, 127, Short.MAX_VALUE)))
                                        .addGroup(layout.createSequentialGroup()
                                                .addGap(47)
                                                .addComponent(jb_modify)
                                                .addGap(18)
                                                .addComponent(jb_reset, GroupLayout.DEFAULT_SIZE, GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)))
